...
class Suit(Clothes):
    ...
    @property
    def height(self):
        return self._height  # Почему тут и ниже мы должны указывать либо защищенныйб либо приватный атрибут?
...
print(m.size, n.height, Clothes.name, Clothes.vol_cloth(m))